...
public class Ex02 
{
	public static void main(String[] args)
	{
		...
		System.out.println(date.getYear()+1900+"년도"); // Calendar.get(Calendar.YEAR) 2021 - 1900.
		...
		System.out.println(date.getDay()+"요일");// Calendar.get(Calendar.DAY_OF_WEEK).(0=>일요일~6=>토요일)
		
		System.out.println("===================================");
		
		// Calendar 클래스
		// 현재 날짜와 시간을 구할때는 new예약어를 사용하지 않고 객체 생성한다.
		// 년, 월, 일, 시, 분, 초를 구할때 Calendar.get(Calendar.상수)를 사용
		System.out.println(Calendar.getInstance().get(Calendar.YEAR)+"년도");
		
		Calendar now = Calendar.getInstance(); // 컴퓨터에 현재 날짜와 시간, 요일을 뜻함
