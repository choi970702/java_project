...
public class Ex08 
{
	...
	{
		// Map interface : Key 와 Value를 매핑하는 구조로 이루어짐
		// Key는 중복될수 없다.(key는 중복되면 덮어쓰기가 된다, value는 중복가능)
		...
		// 인자로 받은 key가 존재하면 true, 없으면 false
		// - containsValue(Object value) : boolean
		// 인자로 받은 value가 존재하면 true, 없으면 false
		// - get(Objcet key) : 키를 받아서 value 값을 리턴한다.
		// - remove(Objcet key) : 키를 받아서 삭제
		...
		System.out.println();
		// 일반적인 for문 사용 가능 개선된 for문은 사용 불가
